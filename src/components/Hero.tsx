      ...
      <Container maxWidth="lg">
        ...
        >
          ...
          <Box sx={{ flex: 1, maxWidth: { md: "600px" } }}>
            ...
            >
              apprelab™ blends focused micro-learning with real-world projects,
              giving you hands-on experience and guided mentorship to build
            ...
            >
              {[
                {
                  icon: SchoolIcon,
                  text: "Affordable Micro-Courses",
                  color: theme.palette.primary.main,
                },
                {
                  icon: AttachMoneyIcon,
                  text: "Real Paid Projects",
            ...
            >
              <Typography
                variant="h3"
                sx={{ mb: 2, fontFamily: 'inherit', fontWeight: 700, fontSize: { xs: "1.5rem", md: "1.75rem" } }}
              >
                Join the Waitlist
              </Typography>
              <Typography
              ...
              <RadioGroup
                ...
                value={role}
                onChange={(e) =>
                  setRole(e.target.value as "learner" | "mentor" | "sme")
                }
                sx={{
                  mb: 1,
                  gap: 1,
              ...
              >
                <FormControlLabel
                  value="learner"
                  control={<Radio />}
                  label={<Typography sx={{ fontFamily: 'inherit', fontSize: 'inherit' }}>Learner</Typography>}
                />
                <FormControlLabel
                  value="mentor"
                  control={<Radio />}
                  label={<Typography sx={{ fontFamily: 'inherit', fontSize: 'inherit' }}>Mentor</Typography>}
                />
                <FormControlLabel 
                  value="sme" 
                  control={<Radio />} 
                  label={<Typography sx={{ fontFamily: 'inherit', fontSize: 'inherit' }}>SME</Typography>} 
                />
              </RadioGroup>
            ...
            >
              ...
              >
                <Box>
                  <Box
                    component="span"
                    sx={{ color: "#C586C0", fontWeight: "bold" }}
                  >
                    import
                  </Box>{" "}
                  ...
                  <Box
                    component="span"
                    sx={{ color: "#569CD6", fontWeight: "bold" }}
                  >
                    const
                  </Box>{" "}
                  <Box component="span" sx={{ color: "#4EC9B0" }}>
